...
cd /d "%REPO_ROOT%"
title Guild Gear Checker v0.9.9 - Qt Kurztest
...
echo   %GGC_QT_ENV%
echo.
echo [1/6] Python / PySide6.QtCore / PySide6.QtWidgets / Pillow
...
echo.
echo [2/6] Tkinter-Kompatibilitaet der noch gemeinsam genutzten Legacy-Logik
"%GGC_QT_PYTHON%" -c "import tkinter; print('tkinter: OK')"
if errorlevel 1 goto :FAIL
echo.
echo [3/6] Compile Qt-Checker
